...
def generate_sample_images():
    ...
    image_folder = "hackathon_images"  # Create this folder and place images inside

    for domain in domains:
        domain_images = {}
        for day in days:
            # Define image filename pattern: "Web Development_1.jpg"
            image_filename = f"{domain.replace(' ', '_')}_{day}.jpg"
            ...
            try:
                ...
                st.warning(f"Image for {domain} on Day {day} not found. Please add {image_filename} to {image_folder}/")
